...
df.applymap(function) applies a function to the all things in specified row or column in the data frame
df.apply(function) applies a function to the entire column
